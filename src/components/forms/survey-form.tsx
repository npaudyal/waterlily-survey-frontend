...
export default function SurveyForm({ survey }: SurveyFormProps) {
    ...
    return (
        <>
            {loading && <FormLoading text="Submitting your survey..." />}
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {isLastSection ? (
                                <button
                                    ...
                                    disabled={loading}
                                    className={`
                                        inline-flex items-center px-6 py-2.5 rounded-lg font-semibold transition-all
                                        ${loading 
                                ...
                                <button
                                    onClick={handleNext}
                                    className="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl"
                                >
                                    Next
