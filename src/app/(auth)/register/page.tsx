...
import { PasswordRequirements, validatePasswordClientSide } from '@/components/ui/password-requirements';
...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const passwordValidation = validatePasswordClientSide(password);
    ...
    return (
        <>
            {loading && <FormLoading text="Creating your account..." />}
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                />
                                <PasswordRequirements password={password} showRequirements={password.length > 0} />
                            </div>
                            <div>
